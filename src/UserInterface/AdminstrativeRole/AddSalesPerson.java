...
public class AddSalesPerson extends javax.swing.JPanel {
    ...
    public AddSalesPerson(JPanel userProcessContainer, Business business, ManageSalesPerson msp) {
        initComponents();
        this.msp = msp;
    ...
    private void initComponents() {
        ...
        addBtn.setText("Add SalesPerson");
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        sp.setFname(fnameTxtField.getText());
        sp.setLname(lnameTxtField.getText());
        sp.setContact(Integer.parseInt(contactTxtField.getText()));
        sp.setEmail(emailTxtField.getText());
                
        UserAccount ua = business.getUserAccountDirectory().addUserAccount();
    
        counter ++;
        String user = new StringBuilder("sales").append(counter).toString();
